...
#   /usr/lib/kubuno/modules/media/{kubuno-media, module.toml, frontend/}
#   /usr/share/kubuno/modules/media/migrations/*.sql
#   /etc/kubuno/modules/media/config.toml.example
#
# Usage :
