...
// This page holds ONLY per-user preferences. Instance administration — the
// metadata provider keys (TMDB/OMDb) and language — moved to the core admin
// console (Modules ▸ Media), see `admin/MediaAdminPanel.tsx`.
